...
from manager.models import Task, Worker, Team
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(attrs={
                "class": "input input-bordered w-full font-bold italic uppercase text-secondary",
            ...
            "priority": forms.Select(attrs={"class": "select select-bordered w-full font-black uppercase"}),
            ...
            "assignees": forms.CheckboxSelectMultiple(attrs={"class": "flex flex-wrap gap-4"}),
            "tags": forms.CheckboxSelectMultiple(attrs={"class": "flex flex-wrap gap-2"}),
